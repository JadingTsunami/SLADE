...
void KeyBind::initBinds()
{
	...
	addBind("map_swap_selection", keypress_t("E", KPM_CTRL|KPM_SHIFT), "Swap Selection", group);
	...
	addBind("me2d_begin_shapedraw_inc_sub", keypress_t("up", KPM_SHIFT|KPM_CTRL), "Increase ellipse sub", group);
	addBind("me2d_begin_shapedraw_dec_sub", keypress_t("down", KPM_SHIFT|KPM_CTRL), "Decrease ellipse sub", group);
	...
	addBind("me2d_line_curve_concave", keypress_t("C", KPM_SHIFT|KPM_ALT), "Curve line(s) (concave)", group);
	addBind("me2d_line_bevel", keypress_t("B", KPM_SHIFT), "Curve line(s) (concave)", group);
	addBind("me2d_line_front_back_texture_copy", keypress_t("F", KPM_ALT), "Make front/back textures the same", group);
	...
	addBind("me2d_sector_make_door", keypress_t("D", KPM_CTRL|KPM_SHIFT), "Make sector into a door", group);
	...
	addBind("me3d_wall_autoalign_y", keypress_t("Y", KPM_CTRL), "Auto-align textures on Y", group);
